      ...
      <main>
        ...
        <div className="flex justify-between items-center mt-[0.4rem] mb-[-0.5rem]">
          ...
          <div className="flex gap-3 items-center mr-[10px]">
            ...
            <a href="https://x.com/linkdhq" target="_blank" rel="noopener noreferrer" aria-label="X (Twitter) profile for Linkd Inc" className="text-[#1a1a1a] hover:opacity-70 transition-opacity">
